...
const CANDIDATES = [
  ...
  { name: "no_pre_fight_context", weights: { pre_fight_context: 0 } },
  { name: "less_pre_fight_context", weights: { pre_fight_context: 0.65 } },
  { name: "more_pre_fight_context", weights: { pre_fight_context: 1.25 } },
